                    ...
                    <div class="panel-body">
                        <form role="form" method="POST" action="/auth/login">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="Senha" name="password" type="password" id="password" value="" required>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Confirmação de senha" name="password_confirmation" type="password" id="password_confirmation" value="" required>
                                </div>
