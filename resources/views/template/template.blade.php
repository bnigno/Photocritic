	...
	<div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/posts">PhotoCritic</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="/posts"><i class="fa fa-home fa-fw"></i> Início</a>
                        </li>
                        <li>
                            <a href="/posts/user/{{$userId}}"><i class="fa fa-list fa-fw"></i> Meus Posts</a>
                        </li>
                        <li>
                            <a href="/about"><i class="fa fa-info-circle fa-fw"></i> Sobre</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
